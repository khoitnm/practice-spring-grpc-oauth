package org.tnmk.practice.springgrpc.client.samplestory.sampleclient;
...
public class ItemSampleClient {
    ...
    @Autowired
    public ItemSampleClient(ItemGrpcConnectionProperties connectionProperties, ItemMapper itemMapper) {
